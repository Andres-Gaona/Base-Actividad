...
<html lang="en">
  <head>
    ...
    <link href="https://fonts.googleapis.com/css?family=Montserrat|Open+Sans:400,600,800|Roboto+Slab:400,700" rel="stylesheet">
...
<div class="vigencia_box white_text text-center promos_tittle_main">Promociones Vigentes </div>


  
  <div class="total_promos">
      ...
      <div class="vigencia_box_promo">Vigencia 19 dic -   2 ene</div>
    </div>
        <div class="promo_item">
      ...
      <div class="vigencia_box_promo">Vigencia  1 jul -  31 dic</div>
    </div>
        <div class="promo_item">
      ...
      <div class="vigencia_box_promo">Vigencia  1 ago -  31 dic</div>
    </div>
