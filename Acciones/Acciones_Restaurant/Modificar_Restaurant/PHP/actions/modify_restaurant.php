...
<html lang="en">
  <head>
    ...
    <title>MODIFICAR RESTARURANT</title>
...
<!-- HTML5 shim and Respond.js for IE8 support of HTML5 elements and media queries -->
  ...
  <div class="tittle_box">Modificar Restaurant</div>
        <form method="post" name="add_restaurant" id="add_restaurant" action="">
          <div>
            <input name="id_hotel" type="hidden" id="id_hotel" value="2">
              
            <input name="current_day" type="hidden" id="current_day" value="1">
              
              <input name="current_restaurant" type="hidden" id="current_restaurant" value="3340">
              ...
              <div class="form-group">
               <select name="id_restaurant" class="form-control" id="id_restaurant" form="add_restaurant">
                                  <option value="9"selected="selected">Doña Rosa</option>
              ...
              <div class="form-group">
               <select name="type_service" class="form-control" id="type_service" form="add_restaurant">
                 <option value="breakfast" selected="selected">Desayuno</option>
              ...
              <div class="form-group">
               <select name="type_food" class="form-control" id="type_food" form="add_restaurant">
                                  <option value="18"selected="selected">Buffet</option>
            ...
            <div class="box_form simple_form_box">
              ...
              <div class="field_box">
                <input style="text-align:center" type="text" name="hour" id="hour" value="07:00:00" class="multiple_option" /></div>
            </div>
              
               <div class="box_form simple_form_box">
              <span class="white_text">Hora Cierre</span>
              <div class="field_box">
                <input style="text-align:center" type="text" name="close" id="close" value="12:00:00" class="multiple_option" /></div>
            </div>
            ...
            <div class="box_form">
              ...
              <div class="form-group">
               <select name="dress" class="form-control" id="dress" form="add_restaurant">
                                  <option value="2"selected="selected">Casual</option>
            ...
            <div class="box_form">
              ...
              <div class="form-group">
                ...
                <select name="reservation" class="form-control" id="reservation" form="add_restaurant">
                  <option value="N" selected="selected">No Requerida</option>
  ...
  <div><a class="button_form green_button" href="javascript:parent.$.fancybox.close();">Cancelar</a><input name="save_restaurant" type="submit" class="button_form purple_button" id="save_restaurant" value="Guardar"></div>
          </form> 
      </div>
    </div>
