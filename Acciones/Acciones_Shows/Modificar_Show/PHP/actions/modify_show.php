  ...
  <body class="total_body">
    ...
    <div class="total_box">
      <div class="form_total_box">
        <div class="tittle_box">Modificar Show</div>
          <div class="tittle_box_show"></div>
        <form method="post" name="add_activitie" id="add_activitie" action="">
          <div>
            <input name="id_hotel" type="hidden" id="id_hotel" value="2">
              
            <input name="id_current" type="hidden" id="id_current" value="">
            <input name="id_activity" type="hidden" id="id_activity" value="">
              
            <input name="current_day" type="hidden" id="current_day" value="">
            ...
            <input name="image_activity" type="hidden" id="image_activity" value="">
